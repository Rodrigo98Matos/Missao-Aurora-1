...
void loop() {
  ...
  if ((WiFi.status() == WL_CONNECTED)) {
   ...
   int httpCode = http.POST("{\"equipe\":2,\"Bateria1\" : ["+String(V_b1)+", "+String(T_b1)+"], \"Bateria2\" : ["+String(V_b2)+", "+String(T_b2)+"]}");
  ...
  Serial.println("{\"equipe\":2,\"Bateria1\" : ["+String(V_b1)+", "+String(T_b1)+"], \"Bateria2\" : ["+String(V_b2)+", "+String(T_b2)+"]}");
